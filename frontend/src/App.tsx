...
import CapsuleCore from "./components/CapsuleCore";
import MegaContract from "./components/MegaContract";
  ...
  return (
    <Router>
      <AppContainer>
        ...
        {/* Header */}
        <Header>
          <h1>Iconoclast Capsule Protocol</h1>
        </Header>
        ...
        <MainContent>
          <TopSection>
            ...
            <Routes>
              ...
              <Route path="/MegaContract" element={<MegaContract />} />
              <Route path="/whitepaper" element={<WhitePaper />} />

              <Route path="/CapsuleCore" element={<CapsuleCore />} />
